class SuperAdmin::CompanySalesTargetsController < SuperAdmin::ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @company_sales_target.save
        format.html { redirect_to super_admin_company_sales_targets_url, notice: "Company sales target was successfully created." }
  ...
  private
    ...
    def company_sales_target_params
      params.require(:company_sales_target).permit(:company_id, :target,  :user_id, :date)
    end
end
