class UserSalesTargetsController < ApplicationController
  ...
  def create
    ...
    user_sales_target.company_id = company.id
  ...
  private
    ...
    def user_sales_target_params
      params.require(:user_sales_target).permit(:user_id, :target, :company_id)
    end
